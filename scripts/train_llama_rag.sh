#!/bin/bash
# ============================================================
# Full training WITH checkpointing (normal QoS, 6-hour wall)
# SIGTERM sent 120s before wall time for graceful checkpoint
# Resume with resume_train.sh if job is killed before completion
# ============================================================
